...
namespace PhantomDragonStudio.CombatMechanics
{
    ...
    public class SingleTargetInstant : ProjectileBehavior
    { 
        public override void Construct(IProjectile projectile)
        {
            //Gather necessary information to complete behavior.
            Debug.Log("AbilityBehavior_SingleTargetMissile: Constructing");
        }

        public override void Perform(IProjectile projectile)
        {
                //Do stuff with info we have
            Debug.Log("AbilityBehavior_SingleTargetMissile: Executing");
        }

        public override void End(IProjectile projectile)
        {
            //Clean up
